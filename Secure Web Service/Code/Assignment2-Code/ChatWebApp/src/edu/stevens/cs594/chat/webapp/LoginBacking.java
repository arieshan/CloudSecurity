...
public class LoginBacking extends BaseBacking {
	...
	public String login() {
		...
		status = securityContext.authenticate(request, response, parameters);
		...
		try {
			 ...
			 */
			loginService.checkOtp(this.username, code);
		 ...
		 */
		validRole = securityContext.isCallerInRole(selectedRole);
		
		logger.info("==============>>>>>>>>>>>>>  valid role: " + validRole);
	...
	public boolean isLoggedIn() {
		...
		return Objects.nonNull(securityContext.getCallerPrincipal());
	}
